 ...
 */
extern "C" DBDRV_CONNECTION EXPORT DrvConnect(char *host, char *login, char *password, char *database,
											  const char *schema, const char *addConnectStr, int sendRetryCount, TCHAR *errorText)
{
	long iResult;
	INFORMIX_CONN *pConn;
